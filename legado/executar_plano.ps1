...
# 3. Carrega o mapa customizado (mapa_final_plano.xodr) no simulador
Write-Host "Carregando mapa_final_plano.xodr..." -ForegroundColor Green
python .\carregar_xodr_plano.py
