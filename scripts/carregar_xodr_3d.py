...
with open(Path(__file__).resolve().parent.parent / 'saida' / 'mapa_final_3d.xodr', 'r', encoding='utf-8') as f:
    xodr_content = f.read()
...
print("Mapa 3D (mapa_final_3d.xodr) carregado com sucesso no CARLA.")
